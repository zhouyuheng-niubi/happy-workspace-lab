  ...
  try {
    ...
    const spawnSession = async (options: SpawnSessionOptions): Promise<SpawnSessionResult> => {
      ...
      try {
        ...
        // Example: REDACTED_CREDENTIAL_NAME="${Z_AI_AUTH_TOKEN}" → REDACTED_CREDENTIAL_NAME="sk-real-key"
        ...
        if (useTmux && tmuxSessionName !== undefined) {
          ...
          // 1. tmux sessions need daemon's expanded auth variables (e.g., REDACTED_CREDENTIAL_NAME)
