...
export default function DevScreen() {
    ...
    const handleEditLogServerUrl = async () => {
        ...
        const newUrl = await Modal.prompt(
            'Remote Log Server',
            'Sends ALL console output as unencrypted plaintext over HTTP to this URL. Use your Mac\'s local IP (e.g. http://10.0.0.1:8787). Run "yarn app-logs" on your Mac to receive. Clear to disable.',
            {
                defaultValue: currentUrl,
                confirmText: 'Save'
            }
